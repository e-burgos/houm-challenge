...
export default function HeaderStats({ currentCoin, loading }: Props) {
    return (
        <>
            {/* Header */}
            <div className='relative bg-lightBlue-600 pb-20 xl:pt-10 lg:pt-10 pt-0 md:pt-10'>
                            ...
                            <div className='flex flex-wrap md:mt-0 mt-20'>
                                <div className='w-full lg:w-6/12 xl:w-6/12 px-4'>
                                    <CardStats
                                        ...
                                        statPercent={
                                            currentCoin.hashing_algorithm ? currentCoin.hashing_algorithm : 'Sin datos'
                                        }
                                        statArrow='right'
                                ...
                                <div className='w-full lg:w-6/12 xl:w-6/12 px-4'>
                                    <CardStats
                                        ...
                                        statPercent={
                                            currentCoin.market_data?.max_supply
                                                ? `${currentCoin.market_data?.max_supply}`
                                                : 'Sin datos'
                                        }
                                        statArrow='right'
                                    ...
                                    <CardStats
                                        ...
                                        statPercent={
                                            currentCoin.market_data?.price_change_24h_in_currency
                                                ? `${currentCoin.market_data?.price_change_24h_in_currency.usd.toFixed(
                                                      2,
                                                  )} USD`
                                                : 'Sin datos'
                                        }
